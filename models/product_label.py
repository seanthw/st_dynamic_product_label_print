...
class ProductLabelWizard(models.TransientModel):
    ...
    def action_print_labels(self):
        ...
        label_rows = int(get_param('st_dynamic_product_label_print.label_rows', default=7))
        label_cols = int(get_param('st_dynamic_product_label_print.label_cols', default=2))
        paperformat_id = int(get_param('st_dynamic_product_label_print.label_paperformat_id', default=0))
        ...
        data = {
            ...
            'rows': label_rows,
            'cols': label_cols,
            'show_barcode_digits': get_param('st_dynamic_product_label_print.label_show_barcode_digits', default=True),
            'show_internal_ref': get_param('st_dynamic_product_label_print.label_show_internal_ref', default=True),
            'show_on_hand_qty': get_param('st_dynamic_product_label_print.label_show_on_hand_qty', default=True),
            'show_attributes': get_param('st_dynamic_product_label_print.label_show_attributes', default=True),
            'font_size': int(get_param('st_dynamic_product_label_print.label_font_size', default=12)),
            'margin_top': int(get_param('st_dynamic_product_label_print.label_margin_top', default=5)),
            'margin_bottom': int(get_param('st_dynamic_product_label_print.label_margin_bottom', default=5)),
            'margin_left': int(get_param('st_dynamic_product_label_print.label_margin_left', default=5)),
            'margin_right': int(get_param('st_dynamic_product_label_print.label_margin_right', default=5)),
        }
